...
class WaveformPhysicalValuesQWidget(ChildQTabWidget):
    ...
    def save_origin_pro(self, op):
        ...
        self.graph_c_v_r = op.new_graph(template='CurrentResistance', lname='Current Voltage Resistance')
        self.workbook_e_p = op.new_book(lname='Power Energy')
        self.graph_e_p = op.new_graph(template='DOUBLEY', lname='Power Energy')
        try:
