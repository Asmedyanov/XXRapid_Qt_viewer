...
from XXRapid_Qt_viewer.ExperimentQWidget.Waveform.WaveformProcessingQTabWidget.WaveformPhysicalValuesQWidget.WaveformResistiveVoltageQWidget.WaveformResistiveVoltageSettingsQWidget import *
